...
<!-- A lowercase b whose bowl is a squircle face with two eyes: the robot baby. The eyes
     are wound the other way so nonzero filling cuts them out of one currentColor path. -->
<svg viewBox="0 0 24 24" aria-hidden="true" class={classProp}>
	<path
		fill="currentColor"
