<script lang="ts">
import { RingChart } from "@baby-ui/svelte";
import { type ChartConfig, ChartContainer, ChartLegend } from "@baby-ui/svelte/chart";
...
<ChartContainer {config} title="Daily goals" aspect="square">
	<RingChart {data} cap="round" />
	<ChartLegend />
</ChartContainer>
