...
const TOPICS: ChatTopic[] = [
	...
	},
	{
		key: "suppliers",
		label: "Suppliers",
		initialPrompt: "Which suppliers are behind schedule?",
		messages: [
			{
			...
			},
			{
				...
				sub: "Delay Analysis",
				time: "5s",
				body: "Cone King's delay traces back to a packaging shortage, expected clear by Friday.",
			},
		],
	},
];

export function ChatComposerDemo({ props: _props }: { props: Props }) {
	return <ChatComposer topics={TOPICS} placeholder="Prompt or tag a flavor with @" />;
}
