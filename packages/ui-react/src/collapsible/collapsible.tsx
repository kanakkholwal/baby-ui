	...
	return (
		<CollapsiblePrimitive.Trigger
			...
			className={cn(
				...
				"[&>svg]:transition-[transform,scale,translate,rotate] [&>svg]:duration-[var(--duration-exit)] [&>svg]:ease-[var(--ease-out)] [&[data-panel-open]>svg]:rotate-90 [&[data-panel-open]>svg]:duration-[var(--duration-dropdown)] motion-reduce:[&>svg]:transition-none",
				className,
			)}
			{...props}
		>
