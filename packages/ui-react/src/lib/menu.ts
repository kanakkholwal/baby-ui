...
/** A submenu trigger stays highlighted like an open item while its own content is open. */
export const menuSubTrigger = tv({
	extend: menuItem,
	variants: {
		open: {
			true: "bg-foreground/[0.06]",
			false: "",
		},
	},
...
/** Hovering a sibling trigger should not instantly steal an already-open submenu. */
